...
files.forEach(file => {
    ...
    // 2. Index Hero
    content = content.replace(/<h1><span class="txt-teal">VITES<\/span> <span class="txt-gold">Designs<\/span><\/h1>/g, '<h1><span class="txt-brand-gradient">VITES Clothing</span></h1>');

    // 3. About Hero
    content = content.replace(/<h1>About <span class="txt-gold">VITES Clothing<\/span><\/h1>/g, '<h1>About <span class="txt-brand-gradient">VITES Clothing</span></h1>');

    // 4. Contact Hero
    content = content.replace(/<h1><span class="txt-teal">Contact<\/span> <span class="txt-gold">VITES Clothing<\/span><\/h1>/g, '<h1><span class="txt-teal">Contact</span> <span class="txt-brand-gradient">VITES Clothing</span></h1>');
