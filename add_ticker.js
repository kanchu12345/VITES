...
const dir = 'f:/fasion';
const files = [
    { file: 'index.html', text: '✨ Welcome to VITES Clothing! &nbsp;|&nbsp; New Arrivals Every Week! &nbsp;|&nbsp; Men | Women | Kids | Accessories &nbsp;|&nbsp; Visit Us: Bosewana, Bandarawela &nbsp;|&nbsp; WhatsApp: 0703430343 &nbsp;|&nbsp; ✨ Fashion for Everyone!' },
    ...
    { file: 'admin.html', text: '✨ Admin Dashboard &nbsp;|&nbsp; Manage Products, Orders, and Customers &nbsp;|&nbsp; VITES Clothing Management System ✨' },
    { file: 'vites-secure-auth-2026.html', text: '✨ Secure Admin Portal &nbsp;|&nbsp; Authorized Personnel Only &nbsp;|&nbsp; VITES Clothing Management System ✨' },
    { file: 'admin-register.html', text: '✨ Admin Registration &nbsp;|&nbsp; Secure Admin Portal &nbsp;|&nbsp; VITES Clothing Management System ✨' }
];
